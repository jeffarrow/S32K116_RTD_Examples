...
#define FTFC_MEM_INFLS_IP_P_FLASH_SIZE                    (0x20000UL)
#define FTFC_MEM_INFLS_IP_P_FLASH_SECTOR_SIZE             (0x800UL)

#define FTFC_MEM_INFLS_IP_D_FLASH_BASE_ADDR               (0x10000000UL)
#define FTFC_MEM_INFLS_IP_D_FLASH_SIZE                    (0x8000UL)
...
#define FTFC_MEM_INFLS_IP_SECTOR_ALIGNED(addr)            (((addr) & (FTFC_MEM_INFLS_IP_P_FLASH_SECTOR_SIZE - 1UL)) == 0UL)

/* Code block size (flash read partition size) */
#define FTFC_MEM_INFLS_IP_P_BLOCK_SIZE                    (0x20000U)

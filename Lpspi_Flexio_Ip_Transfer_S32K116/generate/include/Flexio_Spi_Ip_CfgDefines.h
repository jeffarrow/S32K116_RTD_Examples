...
#else
    #error "PIN_2 cannot be used by SPI driver to configure as TX channel. Channel locked by another driver!"
#endif
...
#else
    #error "PIN_0 cannot be used by SPI driver to configure as CLK channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_PIN_3_USED
    #define FLEXIO_0_PIN_3_USED
#else
    #error "PIN_3 cannot be used by SPI driver to configure as CS channel. Channel locked by another driver!"
#endif
/* Macros that indicate FLEXIO channels used by SPI */

...
==================================================================================================*/
/* Logic Channel 0 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_0_TxAndClk      ((uint32)CHANNEL_0)
/* Logic Channel 1 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_1_RxAndCs      ((uint32)CHANNEL_1)

...
#define FLEXIO_SPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C                 2
...
const Flexio_Spi_Ip_ExternalDeviceType Flexio_Spi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_0 =
{
    ...
    (uint32)39U, /* Normal clock */
    FLEXIO_SPI_IP_TIMCFG_TIMDEC(0),
    ...
    ,(uint32)0u /* SHIFTCFG for RX will be updated in runtime => dont care */

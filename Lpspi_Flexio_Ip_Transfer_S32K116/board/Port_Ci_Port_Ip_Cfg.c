...
- pin_list:
  - {pin_num: '24', peripheral: LPSPI0, signal: lpspi0_sck, pin_signal: PTB2, direction: INPUT}
  - {pin_num: '23', peripheral: LPSPI0, signal: lpspi0_sin, pin_signal: PTB3, direction: INPUT}
  - {pin_num: '15', peripheral: LPSPI0, signal: lpspi0_sout, pin_signal: PTB4, direction: OUTPUT}
  - {pin_num: '14', peripheral: LPSPI0, signal: lpspi0_pcs0, pin_signal: PTB5, direction: INPUT}
  - {pin_num: '2', peripheral: FXIO, signal: fxio_d0, pin_signal: PTD0, direction: OUTPUT}
  - {pin_num: '1', peripheral: FXIO, signal: fxio_d1, pin_signal: PTD1, direction: INPUT}
  - {pin_num: '38', peripheral: FXIO, signal: fxio_d2, pin_signal: PTA0, direction: OUTPUT}
  - {pin_num: '37', peripheral: FXIO, signal: fxio_d3, pin_signal: PTA1, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

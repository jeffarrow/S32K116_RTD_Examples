...
/*! @brief Definitions/Declarations for VS_0 Functional Group */
/*! @brief User number of configured pins */
#define NUM_OF_CONFIGURED_PINS_VS_0 6

#define PORT_START_SEC_CONFIG_DATA_UNSPECIFIED
#include "Port_MemMap.h"

/*! @brief User configuration structure */
extern Port_Ci_Port_Ip_PinSettingsConfig g_pin_mux_InitConfigArr_VS_0[NUM_OF_CONFIGURED_PINS_VS_0];

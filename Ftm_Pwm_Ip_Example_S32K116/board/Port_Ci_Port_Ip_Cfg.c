...
- pin_list:
  - {pin_num: '11', peripheral: FTM0, signal: ftm0_ch0, pin_signal: PTD15, direction: OUTPUT}
  - {pin_num: '47', peripheral: SYSTEM, signal: reset_b, pin_signal: PTA5, direction: INPUT}
  - {pin_num: '44', peripheral: JTAG, signal: jtag_tdo, pin_signal: PTA10}
  - {pin_num: '46', peripheral: JTAG_SWD, signal: jtag_tclk_swd_clk, pin_signal: PTC4}
  - {pin_num: '45', peripheral: JTAG, signal: jtag_tdi, pin_signal: PTC5}
  - {pin_num: '48', peripheral: JTAG_SWD, signal: jtag_tms_swd_dio, pin_signal: PTA4}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
Port_Ci_Port_Ip_PinSettingsConfig g_pin_mux_InitConfigArr_VS_0[NUM_OF_CONFIGURED_PINS_VS_0] = {
    {
        .portBase        = IP_PORTA,
        .gpioBase        = NULL_PTR,
        .pinPortIdx      = 10U,

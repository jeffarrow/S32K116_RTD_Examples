...
#define Port_pin_InputForIcuChannel0_PORT    IP_PTD
#define Port_pin_InputForIcuChannel0_PIN     5U
#define Digital_Output_LED_PORT    IP_PTD
#define Digital_Output_LED_PIN     16U
/*! @brief User number of configured pins */
#define NUM_OF_CONFIGURED_PINS_BOARD_InitPins 3

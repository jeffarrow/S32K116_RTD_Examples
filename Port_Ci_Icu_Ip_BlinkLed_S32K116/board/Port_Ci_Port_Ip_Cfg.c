...
pin_labels:
- {pin_num: '32', pin_signal: PTB13, label: Port_pin_InputForIcuChannel0, identifier: Port_pin_InputForIcuChannel0}
- {pin_num: '11', pin_signal: PTD15, label: Digital_Output_LED, identifier: Digital_Output_LED}
- {pin_num: '18', pin_signal: PTD5, label: Port_pin_InputForIcuChannel0, identifier: Port_pin_InputForIcuChannel0;Digital_Output_LED}
- {pin_num: '10', pin_signal: PTD16, label: Digital_Output_LED, identifier: Digital_Output_LED}
...
- pin_list:
  - {pin_num: '2', peripheral: PORTD, signal: 'port, 0', pin_signal: PTD0, direction: INPUT}
  - {pin_num: '18', peripheral: PORTD, signal: 'port, 5', pin_signal: PTD5, identifier: Port_pin_InputForIcuChannel0, direction: INPUT}

...
- pin_list:
  - {pin_num: '38', peripheral: FXIO, signal: fxio_d2, pin_signal: PTA0}
  - {pin_num: '37', peripheral: FXIO, signal: fxio_d3, pin_signal: PTA1}
  - {pin_num: '35', peripheral: LPI2C0, signal: lpi2c0_scl, pin_signal: PTA3}
  - {pin_num: '36', peripheral: LPI2C0, signal: lpi2c0_sda, pin_signal: PTA2}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

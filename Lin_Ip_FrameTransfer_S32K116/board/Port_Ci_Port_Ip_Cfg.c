...
- pin_list:
  - {pin_num: '34', peripheral: FXIO, signal: fxio_d4, pin_signal: PTD2}
  - {pin_num: '33', peripheral: FXIO, signal: fxio_d5, pin_signal: PTD3}
  - {pin_num: '2', peripheral: FXIO, signal: fxio_d0, pin_signal: PTD0}
  - {pin_num: '1', peripheral: FXIO, signal: fxio_d1, pin_signal: PTD1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

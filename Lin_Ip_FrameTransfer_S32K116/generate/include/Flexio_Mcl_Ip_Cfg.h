...
==================================================================================================*/
/* Logic Channel 0 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_Master_Rx      ((uint32)CHANNEL_0)
/* Logic Channel 1 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_Master_Tx      ((uint32)CHANNEL_1)
/* Logic Channel 2 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_Slave_Tx      ((uint32)CHANNEL_2)
/* Logic Channel 3 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_Slave_Rx      ((uint32)CHANNEL_3)

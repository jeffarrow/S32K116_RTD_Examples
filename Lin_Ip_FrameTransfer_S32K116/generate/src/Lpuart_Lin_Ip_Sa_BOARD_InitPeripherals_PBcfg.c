...
==================================================================================================*/
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_VENDOR_ID_C           43
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION_C      4
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION_C    2
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION_C    0
#define LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION_C    0
...
#if (LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_VENDOR_ID_C != LPUART_LIN_IP_CFG_VENDOR_ID)
    #error "Lpuart_Lin_Ip_SaBOARD_INITPERIPHERALS_PBcfg.c and Lpuart_Lin_Ip_Cfg.h have different vendor ids"
#endif
/* Check if current file and Lpuart_Lin_Ip_Cfg header file are of the same Autosar version */
#if ((LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != LPUART_LIN_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION_C    != LPUART_LIN_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION_C != LPUART_LIN_IP_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of Lpuart_Lin_Ip_SaBOARD_INITPERIPHERALS_PBcfg.c and Lpuart_Lin_Ip_Cfg.h are different"
#endif
/* Check if current file and Lpuart_Lin_Ip_Cfg header file are of the same Software version */
#if ((LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION_C != LPUART_LIN_IP_CFG_SW_MAJOR_VERSION) || \
     (LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION_C != LPUART_LIN_IP_CFG_SW_MINOR_VERSION) || \
     (LPUART_LIN_IP_SABOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION_C != LPUART_LIN_IP_CFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Lpuart_Lin_Ip_SaBOARD_INITPERIPHERALS_PBcfg.c and Lpuart_Lin_Ip_Cfg.h are different"
#endif
...
*
*/
const Lpuart_Lin_Ip_UserConfigType Lpuart_Lin_Ip_Sa_pHwConfigPB_0_BOARD_INITPERIPHERALS =
{

    1U, /*!< Hardware instance */

    0x9C, /*!< Baudrate divisor */
...
*
*/
const Lpuart_Lin_Ip_UserConfigType Lpuart_Lin_Ip_Sa_pHwConfigPB_1_BOARD_INITPERIPHERALS =
{
